...
sum(math.prog$BACKWARD[['2017']]$MATH.08[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="MATH.08"]$COUNT)   #  461008 (repeaters) !!!  ???
...
sum(math.prog$BACKWARD[['2017']]$MATH.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="MATH.09"]$COUNT)   #  9  !!!  ???
...
sum(ela.prog$BACKWARD[['2017']]$ELA.08[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.08"]$COUNT)   #  459663 (repeaters) !!!  ???

sum(ela.prog$BACKWARD[['2017']]$ELA.09[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.08"]$COUNT)   #  3  !!!  ???
sum(ela.prog$BACKWARD[['2017']]$ELA.09[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ELA.07"]$COUNT)   #  4  !!!  ???
sum(ela.prog$BACKWARD[['2017']]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.09"]$COUNT)   #  7  !!!  ???
sum(ela.prog$BACKWARD[['2017']]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ELA.08"]$COUNT)   #  68472
sum(ela.prog$BACKWARD[['2017']]$ELA.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.10"]$COUNT)   #  14536
sum(ela.prog$BACKWARD[['2017']]$ELA.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ELA.09"]$COUNT)   #  2
...
table(SBAC_Data_LONG[, CONTENT_AREA, as.numeric(GRADE)])
table(SBAC_Data_LONG[, STATE, as.numeric(GRADE)]) #  All 9th Graders were missing STATE - so something going on there
